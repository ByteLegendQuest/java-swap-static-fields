...
<h1>Complete the <code class="notranslate">swap</code> Method Which Swaps Static Fields</h1>
<p>Static fields are stored in memory, so we can modify them via methods.</p>
<p>Please complete the <code class="notranslate">swap</code> method in <a href="https://github.com/ByteLegendQuest/java-swap-static-fields/blob/main/src/main/java/com/bytelegend/Challenge.java" target="_blank">src/main/java/com/bytelegend/Challenge.java</a>,
so that after invocation of <code class="notranslate">swap()</code>, the values of static fields <code class="notranslate">a</code> and <code class="notranslate">b</code> are swapped.
I.e. the program should compile and run with output:</p>
<pre class="notranslate"><code class="notranslate">Before swap: a=1, b=2
After swap: a=2, b=1
</code></pre>
<ul>
<li>You can accomplish this challenge via any way below:
<ul>
<li>Recommended for beginners: run <code class="notranslate">git clone https://github.com/ByteLegendQuest/java-swap-static-fields</code> to download the code,
finish the challenge in your local IDE, then copy/paste/submit the answer in web editor.
<ul>
<li>If you don't know how, you can <a href="https://github.com/ByteLegendQuest/java-swap-static-fields/blob/main/docs/en/clone-and-import.md" target="_blank">click here to see detailed docs</a>.</li>
</ul>
</li>
<li>Very unrecommended: you can <a href="https://codeload.github.com/ByteLegendQuest/java-swap-static-fields/zip/refs/heads/main" target="_blank">click here to download zipped code</a> if you don't like <code class="notranslate">git</code> operations.</li>
